...
settings.simulation_name = "RGL, e_th=0.2, n_th=0.1"
settings.agents_params["edges_distance_threshold"] = 0.2
settings.agents_params["nodes_distance_threshold"] = 0.1
settings_set.append(settings)

settings = Settings(environment_tag=EnvironmentIndex.GRID_WORLD, agent_tag=AgentsIndex.RGL,
                    map_tag=MapsIndex.MEDIUM)
settings.simulation_name = "RGL, e_th=0.2, n_th=0.1"
settings.agents_params["edges_distance_threshold"] = 0.3
settings.agents_params["nodes_distance_threshold"] = 0.2
settings_set.append(settings)

settings = Settings(environment_tag=EnvironmentIndex.GRID_WORLD, agent_tag=AgentsIndex.RGL,
                    map_tag=MapsIndex.MEDIUM)
settings.simulation_name = "RGL, e_th=0.2, n_th=0.1"
settings.agents_params["edges_distance_threshold"] = 0.4
settings.agents_params["nodes_distance_threshold"] = 0.3
settings_set.append(settings)
