...
settings = Settings()
settings.environment_tag = EnvironmentIndex.GRID_WORLD
settings.map_tag = MapsIndex.MEDIUM
settings.agent_tag = AgentsIndex.RGL
...
settings.simulation_name = "RGL e=0.15, n=0.05"
settings.agent_default_attributes["edges_distance_threshold"] = 0.2
settings.agent_default_attributes["nodes_distance_threshold"] = 0.1
...
settings.agent_tag = AgentsIndex.RGL
settings = copy.deepcopy(settings)
settings.simulation_name = "RGL e=0.2, n=0.1"
settings.agent_default_attributes["edges_distance_threshold"] = 0.2
settings.agent_default_attributes["nodes_distance_threshold"] = 0.1
settings_set.append(settings)
