...
settings = Settings(environment_tag=EnvironmentIndex.POINT_MAZE, agent_tag=AgentsIndex.REO_RGL,
                    map_tag=MapsIndex.JOIN_ROOMS)
settings.simulation_name = "PO-RGL"
