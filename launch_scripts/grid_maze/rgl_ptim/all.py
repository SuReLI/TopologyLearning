...
settings = Settings(environment_tag=EnvironmentIndex.GRID_WORLD, agent_tag=AgentsIndex.RGL,
                    map_tag=MapsIndex.FOUR_ROOMS, pre_train_in_playground=False)
settings.simulation_name = "RGL 4Rooms GM"
settings_set.append(settings)

settings = Settings(environment_tag=EnvironmentIndex.GRID_WORLD, agent_tag=AgentsIndex.RGL,
                    map_tag=MapsIndex.MEDIUM, pre_train_in_playground=False)
settings.simulation_name = "RGL Medium GM"
settings_set.append(settings)

settings = Settings(environment_tag=EnvironmentIndex.GRID_WORLD, agent_tag=AgentsIndex.RGL,
                    map_tag=MapsIndex.HARD, pre_train_in_playground=False)
settings.simulation_name = "RGL Hard GM"
settings_set.append(settings)

settings = Settings(environment_tag=EnvironmentIndex.GRID_WORLD, agent_tag=AgentsIndex.RGL,
                    map_tag=MapsIndex.JOIN_ROOMS, pre_train_in_playground=False)
settings.simulation_name = "RGL Mixed GM"
settings_set.append(settings)
