...
- If included, all transitions including (i) hindsight action, (ii) sub_goal penalty, (iii) preliminary HER, and (iv) final HER transitions will be printed.  Use below options to print out specific types of transitions.
...
- If included, prints the sub_goal penalty transitions

9. Preliminary HER trans ("prelim_HER")
-If included, prints the preliminary HER transitions (i.e., with TBD rewards and goal components)
