...
class Layer():
    def __init__(self, layer_number, FLAGS, env, sess, agent_params):
        ...
        self.subgoal_penalty = agent_params["sub_goal_penalty"]
    ...
    def train(self, agent, env, trajectory, subgoal_test = False, episode_num = None,):
        ...
        while True:
            ...
            if self.layer_number > 0:
                ...
                goal_status, max_lay_achieved = agent.layers[self.layer_number - 1]\
                    .train(agent, env, trajectory, next_subgoal_test, episode_num)
