...
class GWR_2(TopologyManager):
    ...
    def on_reaching_waypoint_failed(self, last_node, next_node):
        ...
        try:
            nx.shortest_path(self.topology, 0, next_node)
        except:
            # next_node belong to an isolated subgraph. We should remove it.
            self.remove_subgraph(next_node)
