...
class AntFourRoomsMDP(GoalDirectedMDP):
    def __init__(self, goal_state, seed=0, render=False):
    ...
    def reset(self):
        ...
        super(AntFourRoomsMDP, self).reset()
    ...
    def in_collision(self, point0):
        ...
        for point in points:
            if self.env._is_in_collision(point):
                return True
        return False
