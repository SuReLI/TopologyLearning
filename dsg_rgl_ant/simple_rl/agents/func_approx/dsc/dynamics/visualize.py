...
def generate_data(mdp, epochs):
    ...
    positions = [np.array([0,0]), np.array([4,0]), np.array([8,0]), np.array([8,2]), np.array([8,4]), np.array([8,6]), np.array([8,8]), np.array([6,8]), np.array([4,8]), np.array([2,8]), np.array([0,8])]
...
mdp.reset()
_, steps_taken1, trajectory_1 = mpc._rollout_debug(mdp, 14000, 7, np.array([0,8]), max_steps=300)
